...
export default function Footer() {
    return (
        <div className={"flex flex-col"}>
            <p className={`${subFont.className} order-1 md:order-2 text-white text-[18px] text-opacity-80 pt-[64px] md:pt-[16px] ml-[16px] md:ml-[64px] w-[87%] md:w-[100%] md:max-w-[640px]`}>
