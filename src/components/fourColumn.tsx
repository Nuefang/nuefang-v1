...
export default function FourColumn() {
    return (
        <div className={"flex flex-col m-0 lg:grid lg:grid-cols-2 lg:gap-10 pt-[64px] lg:pt-[64px] lg:place-items-center items-center justify-center space-y-[32px] lg:space-y-0 lg:px-[128px]"}>
            <ColumnBlock
