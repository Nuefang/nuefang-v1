...
export default function Page() {
    return <main className={"bg-lightGrey text-subTextInvert"}>
    <div className="flex flex-col w-[90vw] p-8">
        <div className={"pb-[32px]"}>
            <a href={"/"}>
                <Image src={"/nuefang_white.png"} key={"nuefang"} alt={"Nuefang Logo"} width={55} height={55} className={"max-w-[40px]"} />
            </a>
        </div>
        <div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Nuefang Limited, 15 Pembroke Avenue, Blackpool, FY2 9PS.</p><br/>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Service Provider</strong> means any natural or legal person who processes the data on
                        ...
                        related to the Service or to assist the Company in analyzing how the Service is used.</p><br/>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Nuefang, accessible from <a href="https://nuefang.com/"
                                                                                      rel="external nofollow noopener"
                                                                                      target="_blank">https://nuefang.com</a>
                    </p><br/>
                </li>
                <li>
            ...
            <h3 id={"cookies"}>Tracking Technologies and Cookies</h3><br/>
            <p>Our service strictly adheres to a cookie-free policy, which encompasses functional, required,
                and optional cookies. We do not utilize any tracking mechanisms. As a result, no personal data or
                user activities are recorded or monitored through cookies. This approach ensures complete privacy and
                compliance with legal regulations, assuring our users that their online experience remains anonymous
                and secure without compromising their data.</p><br/>
            ...
            <ul>
                ...
                <li>
                    <p><strong>For other purposes</strong>: We may use Your information for other purposes, such as data
                        ...
                        and to evaluate and improve our Service, products, services, marketing and your experience.</p><br/>
                </li>
            </ul>
            ...
            <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
                ...
                data and other personal information.</p><br/>
            ...
            <p>You have the right to delete or request that We assist in deleting the Personal Data that We have
                collected about You.</p><br/>
            <p>If you wish to delete your Personal Data that we have stored, please email us at: hello@nuefang.com</p><br/>
            ...
            <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over
                ...
                acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p><br/>
            {/* eslint-disable-next-line react/no-unescaped-entities */}
            ...
            <p>Our Service does not address anyone under the age of 13. We do not knowingly collect personally
                ...
                We take steps to remove that information from Our servers.</p><br/>
            ...
            <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new
                Privacy Policy on this page.</p><br/>
            <p>We will let You know via a prominent notice on our Privacy Policy page, prior to the change becoming
                {/* eslint-disable-next-line react/no-unescaped-entities */}
                effective and update the "Last updated" date at the bottom of this Privacy Policy.</p><br/>
            ...
            <ul>
                <li>By email: hello@nuefang.com</li><br/>
            </ul>
            <p>Last updated: July 27, 2023</p><br/>
        </div>
    </div>
        <a href={"/"}>
            <Image src={'/footer.png'} alt={'Nuefang Footer'} height={50} width={300} className={"pl-[16px] pt-[16px] md:pt-[32px] pb-[16px]"} />
        </a>
    </main>
}