...
export default function ContactUs() {
    return (
        <div className={"flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 lg:gap-12 md:gap-10 justify-start mt-[64px] ml-[16px] md:mt-[128px] md:ml-[64px] lg:ml-[128px] lg:space-x-[6vw]"}>
