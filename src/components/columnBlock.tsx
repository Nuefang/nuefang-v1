...
export default function ColumnBlock(props: BlockProps) {
    return (
        <div className={`flex flex-col justify-end items-start h-[386px] max-w-[351px] w-[95vw] md:max-w-[640px] lg:max-w-[316px] py-[32px] px-[16px] border-[1px] border-opacity-[0.6] border-${props.theme}`}>
